...
export const getSKLAccountDataFromSale = (sale, account) =>
...
export const renderSKLBody = ({ values, grant, readOnly, netTotal }) => (
  <Fragment>
    ...
    <Row>
      <Col md="4">
        <Form.Item name="contractDeliverDate" label="วันที่ส่งสัญญา SKL" rules={getRules(['required'])}>
          <DatePicker disabled={!grant} readOnly={readOnly} />
        </Form.Item>
      </Col>
      <Col md="4">
        <Form.Item name="contractAmtReceivedDate" label="วันที่รับเงิน SKL" rules={getRules(['required'])}>
          <DatePicker disabled={!grant} readOnly={readOnly} />
        </Form.Item>
      </Col>
    </Row>
