...
import { getNetTotal, renderSale, renderSKLBody } from './api';
        ...
        {values => {
          ...
          return (
            <Card small className="mb-4">
              ...
              <CardBody>{renderSKLBody({ values, grant, netTotal: netTotal.current })}</CardBody>
            </Card>
          );
        }}
      </Form>
