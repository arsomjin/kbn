    ...
    <Row>
      <Col md="3">
        <Form.Item name="incomeSubCategory" label="ประเภทการรับเงิน">
          <Select placeholder="ประเภทการรับเงิน" className="text-primary">
  ...
  return (
    <>
        ...
        <Row>
          <Col md="4">
            <Form.Item name="incomeSubCategory" label="ประเภทสินค้า">
              <Select disabled placeholder="ประเภทการรับเงิน" className="text-primary">
                {Object.keys(IncomeDailyCategories).map((type, i) => (
                  <Option
                    key={i}
                    value={type}
      ...
      <Card>
        ...
        <Row gutter={[16, 16]}>
          <Col md="4">
            <Form.Item name="pLoanNo" label="เลขที่เอกสาร" rules={getRules(['required'])}>
              <Input placeholder="กรุณาป้อนเลขที่เอกสาร" disabled={!grant} readOnly={readOnly} />
            </Form.Item>
          </Col>
          <Col md={4}>
            <Form.Item name="payDate" label="วันที่รับเงิน" rules={getRules(['required'])}>
              <DatePicker style={{ width: '100%' }} />
            </Form.Item>
          </Col>
          <Col md={4}>
            <Form.Item name="amtReceived" label="จำนวนเงินที่ได้รับ" rules={getRules(['required'])}>
        ...
        <Row gutter={[16, 16]}>
          <Col md={8}>
            <Form.Item name="selfBankId" label="ธนาคาร" rules={getRules(['required'])}>
              <SelfBankSelector placeholder="ธนาคาร" />
            </Form.Item>
          </Col>
          <Col md={4}>
            <Form.Item name="loanIncomeReceiver" label="บันทึกข้อมูลโดย" rules={getRules(['required'])}>
