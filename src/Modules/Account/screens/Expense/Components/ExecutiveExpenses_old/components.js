...
const renderLedgerInput = (form, values) => (
  <div className="bg-white">
    ...
    <Row>
      ...
      <Col md="6">
        <Form.Item name="expenseAccountName" rules={getRules(['required'])}>
          <InputGroup
            spans={[10, 14]}
            addonBefore="ชื่อบัญชีรายจ่าย"
            inputComponent={props => <ExpenseNameSelector record={values} style={{ width: '100%' }} {...props} />}
          />
        </Form.Item>
      </Col>
    </Row>
