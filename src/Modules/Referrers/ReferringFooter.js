...
export default ({ isCreditCheck, isAccountCheck, isReport, hasReferrer }) => (
    ...
    <Row>
      <Col md="6" className="border-right">
        ...
        <Form.Item
          ...
          rules={
            hasReferrer && !(isCreditCheck || isAccountCheck || isReport) ? [...getRules(['required'])] : undefined
          }
        >
          <InputGroup
            spans={[10, 14]}
        ...
        <Row>
          ...
          <Col md="4">
            <Form.Item
              ...
              // }
            >
              <InputGroup spans={[14]} inputComponent={props => <DatePicker {...props} />} disabled={!isCreditCheck} />
            </Form.Item>
          </Col>
        </Row>
        <Form.Item
          ...
          // }
        >
          <InputGroup spans={[10, 14]} addonBefore="ผู้บริหาร (อนุมัติค่าแนะนำ)" disabled={!isCreditCheck} />
        </Form.Item>
        <Form.Item
        ...
        <Row>
          ...
          <Col md="4">
            <Form.Item
              ...
              rules={hasReferrer && isAccountCheck ? [...getRules(['required'])] : undefined}
            >
              <InputGroup spans={[14]} inputComponent={props => <DatePicker {...props} />} disabled={!isAccountCheck} />
            </Form.Item>
          </Col>
        </Row>
        <Form.Item
