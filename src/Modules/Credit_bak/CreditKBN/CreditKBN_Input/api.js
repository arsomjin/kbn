...
export const getKBNCreditDataFromSale = (sale, credit) =>
...
export const renderKBNBody = ({ values, grant, readOnly, netTotal }) => (
  <Fragment>
    ...
    <Row>
      <Col md="4">
        <Form.Item name="contractDeliverDate" label="วันที่ส่งสัญญา KBN" rules={getRules(['required'])}>
          <DatePicker disabled={!grant} readOnly={readOnly} />
        </Form.Item>
      </Col>
      <Col md="4">
        <Form.Item name="contractAmtReceivedDate" label="วันที่รับเงิน KBN" rules={getRules(['required'])}>
          <DatePicker disabled={!grant} readOnly={readOnly} />
        </Form.Item>
      </Col>
    </Row>
