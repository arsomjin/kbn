...
export const getBAACreditDataFromSale = (sale, credit) =>
...
export const renderBAABody = ({ values, grant, readOnly, netTotal }) => (
  <Fragment>
    ...
    <Row>
      ...
      <Col md="6">
        <Form.Item name="date" label="วันที่บันทึก" rules={getRules(['required'])}>
    ...
    <Row>
      <Col md="6">
        <Form.Item name="contractDeliverDate" rules={getRules(['required'])}>
          <InputGroup addonBefore="วันที่ส่งสัญญา สกต./ธกส." alignRight disabled={!grant} readOnly={readOnly} date />
        </Form.Item>
      </Col>
      <Col md="6">
        <Form.Item name="contractAmtReceivedDate" rules={getRules(['required'])}>
          <InputGroup addonBefore="วันที่รับเงิน สกต./ธกส." alignRight disabled={!grant} readOnly={readOnly} date />
        </Form.Item>
      </Col>
    </Row>
    <Row>
      <Col md="6">
        <Form.Item name="contractAmtReceivedBank" rules={getRules(['required'])}>
          <InputGroup addonBefore="ธนาคารที่รับเงินโอน" disabled={!grant} readOnly={readOnly} selfBank />
        </Form.Item>
      </Col>
      <Col md="6">
    ...
    <Row>
      <Col md="6">
        <Form.Item name="baacNo" rules={getRules(['required'])}>
          <InputGroup addonBefore="เลขที่ใบ ธกส./สกต." alignRight disabled={!grant} readOnly={readOnly} />
        </Form.Item>
      </Col>
      <Col md="6">
        <Form.Item name="baacDate" rules={getRules(['required'])}>
          <InputGroup addonBefore="วันที่ใบ ธกส./สกต." alignRight disabled={!grant} readOnly={readOnly} date />
        </Form.Item>
      </Col>
    </Row>
    {/* <Row>
    ...
    <Row>
      <Col md="6">
        <Form.Item name="taxInvoice" rules={getRules(['required'])}>
          <InputGroup addonBefore="ใบกำกับภาษีขาย" alignRight disabled={!grant} readOnly={readOnly} />
        </Form.Item>
      </Col>
      <Col md="6">
        <Form.Item name="taxInvoiceDate" rules={getRules(['required'])}>
          <InputGroup addonBefore="วันที่ใบกำกับภาษี" alignRight disabled={!grant} readOnly={readOnly} date />
        </Form.Item>
      </Col>
    </Row>
    <Row>
