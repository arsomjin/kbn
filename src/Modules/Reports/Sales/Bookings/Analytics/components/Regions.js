...
// import Map from 'Modules/Utils/Map';
...
class CountryReports extends React.Component {
  ...
  render() {
    const { title, data, branches } = this.props;
                ...
                {data.map((country, idx) => (
                  <tr key={idx}>
                    <td>
                      ...
                      {country.branch ? branches[country.branch].branchName : 'ไม่ระบุ'}
                    </td>
                    <td className="text-right">{country.counter}</td>
