...
const BookingAnalytics = () => {
  ...
  const { vehicleType, saleType, saleModels, salesPerson, zone, sessionsData, smallStatsData, saleItems, sales } = data;
