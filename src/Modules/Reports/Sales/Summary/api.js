...
export const formatSaleData = (snap, typeSnap) => {
...
export const getSaleData = ({ branchCode, saleType }) =>
  new Promise(async (r, j) => {
    try {
      ...
      let fArr = [];
      let arr = saleArr.map(it => {
        const nArr = formatSaleData(it, typeSnap);
        fArr = [...fArr, ...nArr];
        return it;
      });
