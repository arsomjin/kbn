...
// Hover styles
const getHoverStyle = (variant = 'default', disabled = false) => {
  if (disabled) return {};
  ...
  return hoverStyles[variant] || hoverStyles.default;
};
...
const CustomButton = forwardRef(
  (
    ...
    // Determine Ant Design type based on variant for better semantic colors
    const getAntType = () => {
      ...
      switch (variant) {
        case 'primary':
          return 'primary';
        case 'danger':
          return 'primary'; // Use primary type with danger styling
        case 'success':
          return 'primary'; // Use primary type with success styling
        case 'warning':
          return 'primary'; // Use primary type with warning styling
        case 'ghost':
          return 'ghost';
        case 'text':
          return 'text';
        case 'secondary':
          return 'default';
        default:
          return 'default'; // Default to Ant Design's default type
      }
    };
