...
export const googleRed = '#e13b37';
export const googleGreen = '#2e9e49';
export const googleYellow = '#fbb30a';
export const googleBlue = '#397af2';
...
export const LINEAR_BROWN = ['#cc6600', '#663300', '#4d2600'];
export const LINEAR_BROWN_LIGHT_UP = ['#663300', '#cc6600', '#ffb366'];
export const LINEAR_BLUE = ['#3377ff', '#002266', '#001a4d'];
export const LINEAR_RED = ['#cc0044', '#4d0019', '#330011'];
export const LINEAR_LIGHT_RED = ['#ff8566', '#ff3300', '#801a00'];
export const LINEAR_RED_LIGHT_UP = ['#80002a', '#4d0019', '#ff3377'];
export const LINEAR_PINK_LIGHT_UP = ['#800040', '#ff4da6', '#ff80bf'];
export const LINEAR_PINK = ['#ff80bf', '#ff4da6', '#800040'];
export const LINEAR_HEADER_PINK = ['#ff80bf', '#cc0066', '#cc0066'];
export const LINEAR_PURPLE = ['#990099', '#4d004d', '#330033'];
export const LINEAR_PURPLE_LIGHT_UP = ['#660066', '#4d004d', '#b300b3'];
export const LINEAR_GREEN = ['#00e600', '#008000', '#004d00'];
export const LINEAR_YELLOW = ['#ffff00', '#808000', '#4d4d00'];
export const LINEAR_FAB = ['#b3ecff', '#00bfff', '#007399'];
export const LINEAR_FAB_LIGHT_UP = ['#006080', '#00bfff', '#80dfff'];
export const baseColors = {
  ...
  divider: '#9fa1ad',
  // linear: ['rgb(180,199,231)', 'rgb(47,85,151)', 'rgb(13,15,105)'],
  linear: ['rgb(13,15,105)', 'rgb(47,85,151)', 'rgb(180,199,231)'],
  // linear: ['#f6f6f6', '#f6f6f6', '#f6f6f6'],
  linearSurface: ['#fff', '#fff', '#fff'],
  linearBrand: ['#ffb499', '#ff7c4d', '#ff4400']
};

export const PieChartColors = ['#499BA7', '#9C7685', '#F2918B', '#FAA375', '#FFBA62'];
...
export const getColors = index => PieChartColors[index % PieChartColors.length];
export const getColors2 = index => PieChartColors2[index % PieChartColors2.length];
