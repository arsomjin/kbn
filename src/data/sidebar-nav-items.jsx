import {
  ...
  ReadOutlined,
  InfoCircleOutlined,
  // Fallback icons if specific ones are not found or for general use
  AppstoreOutlined, // Generic application/module
  DatabaseOutlined, // Data management
  FileTextOutlined, // Documents/files
  UserOutlined, // Users/profile
  ScheduleOutlined, // Calendar/schedule
  FormOutlined, // Forms/input
  WarningOutlined, // Errors/warnings
  LayoutOutlined, // Layouts
  ...
  QuestionCircleOutlined, // Forgot Password
  HistoryOutlined, // Transaction History
  CalendarOutlined, // Calendar
  FileAddOutlined, // Add New Post
  ExclamationCircleOutlined, // Errors
  ToolOutlined, // Components Overview
  BuildOutlined, // Icon Sidebar
  MenuOutlined, // Header Nav
...
export default function () {
  return [
      ...
      items: [
        {
          title: 'หน้าแรก',
          to: '/overview',
          icon: <DashboardOutlined />, // Replaced icon
          htmlAfter: '',
          // permCat: "permCat001",
          key: '1',
        },
      ...
      items: [
        {
          title: 'บัญชี',
          key: '4',
          icon: <AccountBookOutlined />, // Replaced icon
          open: false,
          items: [
            {
              title: 'รายรับ',
      ...
      items: [
        {
          title: 'งานขาย',
          key: '23',
          icon: <ShoppingCartOutlined />, // Replaced icon
          open: false,
          items: [
            {
              title: 'งานรับจอง',
      ...
      items: [
        {
          title: 'งานบริการ',
          key: '31',
          icon: <CustomerServiceOutlined />, // Replaced icon
          open: false,
          items: [
            // {
      ...
      items: [
        {
          title: 'คลังสินค้า',
          key: '36',
          icon: <HomeOutlined />, // Replaced icon
          open: false,
          items: [
            {
              title: 'รถและอุปกรณ์',
      ...
      items: [
        {
          title: 'สินเชื่อ',
          key: '61',
          icon: <CreditCardOutlined />, // Replaced icon
          open: false,
          items: [
            {
              title: 'บันทึกข้อมูล',
      ...
      items: [
        {
          title: 'บุคคล',
          key: '90',
          icon: <TeamOutlined />, // Replaced icon
          htmlAfter: '',
          permCat: 'permCat007',
          items: [
            {
      ...
      items: [
        {
          ...
          key: '77',
          // to: "/reports",
          icon: <BarChartOutlined />, // Replaced icon
          htmlAfter: '',
          // permCat: "permCat008",
          items: [
            {
      ...
      items: [
        {
          title: 'การตั้งค่า',
          key: '96',
          icon: <SettingOutlined />, // Replaced icon
          open: false,
          items: [
            {
              title: 'ทั่วไป',
      ...
      items: [
        {
          ...
          key: '107',
          icon: <ReadOutlined />, // Replaced icon
          htmlAfter: '',
          items: [
            {
              title: 'บัญชี',
      ...
      items: [
        {
          title: 'เกี่ยวกับ',
          key: '114',
          icon: <InfoCircleOutlined />, // Replaced icon
          htmlAfter: '',
          items: [
            {
              title: 'เกี่ยวกับเรา',
    ...
    //     {
    //       title: 'User Account',
    //       icon: <UserOutlined />, // Replaced icon
    //       open: false,
    //       items: [
    //         {
    //           title: 'User Profile',
    ...
    //       icon: <HistoryOutlined />, // Replaced icon
    //       to: '/transaction-history',
    //     },
    //     {
    //       title: 'Calendar',
    //       icon: <CalendarOutlined />, // Replaced icon
    //       to: '/calendar',
    //     },
    //     {
    //       title: 'Add New Post',
    //       icon: <FileAddOutlined />, // Replaced icon
    //       to: '/add-new-post',
    //     },
    //     {
    //       title: 'Errors',
    //       icon: <ExclamationCircleOutlined />, // Replaced icon
    //       to: '/errors',
    //     },
    //   ],
    // },
    ...
    //     {
    //       title: 'Overview',
    //       icon: <ToolOutlined />, // Replaced icon
    //       to: '/components-overview',
    //     },
    //     {
    //       title: 'Tables',
    //       icon: <TableOutlined />, // Replaced icon
    //       to: '/tables',
    //     },
    //     {
    //       title: 'Blog Posts',
    //       icon: <ProfileOutlined />, // Replaced icon
    //       to: '/blog-posts',
    //     },
    //   ],
    // },
    ...
    //     {
    //       title: 'Header Nav',
    //       icon: <MenuOutlined />, // Replaced icon
    //       to: '/header-navigation',
    //     },
    //     {
    //       title: 'Icon Sidebar',
    //       icon: <BuildOutlined />, // Replaced icon
    //       to: '/icon-sidebar-nav',
    //     },
    //   ],
    // },
