...
const BranchDashboard: React.FC = () => {
  ...
  return (
    <div className={isMobile ? 'p-2' : 'p-6'}>
      <Title level={isMobile ? 3 : 2}>Branch Dashboard</Title>
      <p className='text-gray-500 mb-6'>
        Welcome back, {userProfile?.displayName || 'Branch Manager'}. Here's your branch overview.
      </p>
      ...
      <Card className='mb-6'>
        <p className={isMobile ? 'text-sm' : ''}>
          Your branch is performing well with {branchStats.completedTasks} completed tasks this month.
        </p>
      </Card>
      ...
      <Card>
        <p className={isMobile ? 'text-sm' : ''}>No recent branch activities to display.</p>
      </Card>
    </div>
  );
};
