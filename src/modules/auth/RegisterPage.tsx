    ...
    modal.confirm({
      ...
      onOk: async () => {
        ...
        try {
          ...
          // Notify admins, super_admins, and privileged users about new pending user
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.3 }}>
                      ...
                      <Row gutter={[16, 0]}>
                        <Col xs={24} sm={12}>
                          ...
                          >
                            <Input
                              prefix={<BankOutlined className='text-primary mr-2' />}
