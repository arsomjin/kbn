...
const CompleteProfilePage = () => {
  ...
  const onFinish = (values) => {
    ...
    showConfirm({
      ...
      content: t(
        'profile:confirmSubmitContent',
        'Are you sure you want to submit your profile information?',
      ),
      onOk: async () => {
  ...
  return (
    <>
      <AuthContainer
        ...
        subtitle={t(
          'profile:completeProfileSubtitle',
                    ...
                    <Form.Item
                      ...
                      rules={[
                        { required: true, message: t('validation:required') },
                        {
                          pattern: /^[0-9]{9,15}$/,
                          message:
                            t('validation:phoneNumber') || 'Please enter a valid phone number',
                        },
                      ]}
                    >
                      <Input
