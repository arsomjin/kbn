...
const Excels = ({ firstRowIsHeader, onDataLoaded, style, title }) => {
  ...
  const [imgSrc, setImg] = useState('/src/images/ExcelForImport.png');

  useEffect(() => {
    switch (title) {
      case 'รับรถและอุปกรณ์':
        setImg('/src/images/ExcelForImport.png');
        break;
      case 'รับอะไหล่':
        setImg('/src/images/ExcelForImportParts.png');
        break;
      case 'รายได้งานบริการ':
        setImg('/src/images/ExcelForImportServiceIncome.png');
        break;
      case 'รายได้ขายอะไหล่':
        setImg('/src/images/ExcelForImportPartIncome.png');
        break;
      case 'รายการรถและอุปกรณ์':
        setImg('/src/images/ExcelForImportModelList.png');
        break;
      // case 'รายการอะไหล่':
      //   break;
      case 'การสแกนลายนิ้วมือ':
        setImg('/src/images/ExcelForImportFingerPrint.png');
        break;
    ...
    <div style={style}>
      <div className="border-bottom bg-white p-3">
        <h6 className="text-primary">
          {isLoaded ? 'กรุณาตรวจสอบข้อมูล ก่อนอัปโหลด' : `อัปโหลดข้อมูล ${title}`}
        </h6>
        {!isLoaded && (
          <div>
            <div>
