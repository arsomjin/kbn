...
import { h, w } from 'api';
import { searchArr } from 'utils/functions';
...
const CustomerList = () => {
  ...
  const _onHeaderChange = (headerChange) => {
    ...
    let dArr =
      params?.data ||
      (branch && branch !== 'all' ? mCustomers.filter((l) => l.branch === branch) : mCustomers);
    if (searchText) {
      dArr = searchArr(dArr, headerChange.searchText, [
        'firstName',
        'lastName',
        'phoneNumber',
        'customerNo',
      ...
      <div>
        <div className="main-content-container px-4">
          ...
          <EditableCellTable
            ...
            hasChevron
          />
          <div className="border-top" style={{ padding: '16px 0' }}>
