      ...
      <Row gutter={16} className="mb-4 mt-4">
        <Col xs={24} md={8}>
          <Form.Item
            ...
            rules={[
              { required: canEditEditedBy, message: t('selectEditor', 'กรุณาเลือกผู้แก้ไข') },
            ]}
          >
            {canEditEditedBy ? (
              ...
              <Tooltip
                title={t('noPermissionEdit', 'You do not have permission to edit this field.')}
              >
          ...
          <Form.Item
            ...
            rules={[
              { required: canEditEditedBy, message: t('selectEditDate', 'กรุณาเลือกวันที่แก้ไข') },
            ]}
          >
            {canEditEditedBy ? (
        ...
        <Col xs={24} md={8}>
          <Form.Item
            ...
            rules={[
              { required: canEditReviewedBy, message: t('selectReviewer', 'กรุณาเลือกผู้ตรวจสอบ') },
            ]}
          >
            {canEditReviewedBy ? (
              <EmployeeSelector disabled={false} />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: canEditReviewedBy,
                message: t('selectReviewDate', 'กรุณาเลือกวันที่ตรวจสอบ'),
              },
            ]}
          >
            {canEditReviewedBy ? (
        ...
        <Col xs={24} md={8}>
          <Form.Item
            ...
            rules={[
              { required: canEditApprovedBy, message: t('selectApprover', 'กรุณาเลือกผู้อนุมัติ') },
            ]}
          >
            {canEditApprovedBy ? (
              <EmployeeSelector disabled={false} />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: canEditApprovedBy,
                message: t('selectApproveDate', 'กรุณาเลือกวันที่อนุมัติ'),
              },
            ]}
          >
            {canEditApprovedBy ? (
