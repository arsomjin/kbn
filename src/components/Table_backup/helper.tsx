...
import { CheckOutlined, InfoCircleOutlined, CheckCircleOutlined, CloseCircleOutlined, CloseOutlined } from '@ant-design/icons';
import {
  PriceType,
  WitholdingTax,
  WitholdingTaxDoc,
    ...
    if ('titleAlign' in col && col.titleAlign) {
      switch (col.titleAlign) {
        case 'left':
          mCol = {
            ...mCol,
            title: typeof col.title === 'string' ? col.title : React.isValidElement(col.title) ? col.title : String(col.title)
          };
          break;
        case 'right':
          mCol = {
