    ...
    switch (screenType) {
          ...
          steps: [
            {
              ...
              description: 'เลือกว่าคุณเป็นพนักงานใหม่ หรือพนักงานเดิมที่ต้องการเข้าสู่ระบบ',
              icon: <UserOutlined />,
              details: [
      ...
      case 'system-configuration':
        return {
          ...
          subtitle: 'การจัดการระบบระดับผู้บริหารสำหรับจังหวัด สาขา และการตั้งค่าเชิงกลยุทธ์',
          steps: [
            {
              title: 'ภาพรวมระบบ',
        ...
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          >
            <Space direction="vertical" size="small">
              <Text>💡 <strong>ติดปัญหา?</strong> กดปุ่มช่วยเหลือ (?) ได้ทุกหน้า</Text>
              <Text>📞 <strong>ต้องการความช่วยเหลือ?</strong> ติดต่อ IT Support</Text>
              <Text>🎯 <strong>ใช้งานครั้งแรก?</strong> ลองทำตามขั้นตอนทีละขั้น</Text>
            </Space>
          </Card>
