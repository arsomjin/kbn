...
const CustomerDetailsModal: React.FC<CustomerDetailsModalProps> = ({ selectedCustomer, visible, onOk, onCancel }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Row gutter={16}>
          <Col span={6}>
            <Form.Item name='prefix' label='คำนำหน้า' rules={[{ required: true, message: 'กรุณากรอกคำนำหน้า' }]}>
              <Select>
        ...
        <Row gutter={16}>
          <Col span={8}>
            <Form.Item name='subDistrict' label='ตำบล/แขวง' rules={[{ required: true, message: 'กรุณากรอกตำบล/แขวง' }]}>
              <Input />
            </Form.Item>
          </Col>
          <Col span={8}>
            <Form.Item name='district' label='อำเภอ/เขต' rules={[{ required: true, message: 'กรุณากรอกอำเภอ/เขต' }]}>
              <Input />
            </Form.Item>
          </Col>
          <Col span={8}>
