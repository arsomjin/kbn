...
export const TableSummary = ({
  ...
  const relevantRows = hasSection
    ? filteredData.filter((l) => l?.isSection)
    : filteredData.filter((l) => !l?.isSection);
                ...
                return (
                  <Table.Summary.Cell key={colDataIndex} align={getCellAlign(colDataIndex)}>
                    <div style={{ textAlign: getCellAlign(colDataIndex) }}>
                      <Text
                        className={
                          sumClassName && sumClassName[colDataIndex]
                            ? sumClassName[colDataIndex]
                            : 'text-primary'
                        }
                      >
            ...
            return (
              <Table.Summary.Cell key={k} align={getCellAlign(k)}>
                <div style={{ textAlign: getCellAlign(k) }}>
                  <Text
                    className={sumClassName && sumClassName[k] ? sumClassName[k] : 'text-primary'}
                  >
