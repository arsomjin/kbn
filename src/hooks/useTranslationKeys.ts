...
export const useModalTranslations = (
  namespace: string = 'userRoleManager',
  keyPrefix: string = 'editModal'
) => {
  ...
  return {
    ...
    modal: {
      ...
      provincesSection: {
        ...
        autoAccessDescription: getTranslation('autoProvinceAccessDescription', 'autoProvinceAccessDescription', 'This role has access to all provinces'),
        employeeWarning: getTranslation('employeeProvinceWarning', 'employeeProvinceWarning', 'Employee is assigned to province: {{provinceName}}')
      },
      summarySection: {
