      ...
      },
      {
        ...
        Cell: row => (
          <div>
            ...
            <span className="file-manager__item-meta">Last opened {row.original.lastOpened} ago</span>
          </div>
        )
      },
      {
            ...
            <Container fluid className="file-manager__filters border-bottom">
              <Row>
                ...
                <Col className="file-manager__filters__rows d-flex">
                  <span>Show</span>
                  <FormSelect size="sm" onChange={this.handlePageSizeChange} value={this.state.pageSize}>
