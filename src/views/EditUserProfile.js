              ...
              <Card small className="edit-user-details mb-4">
                ...
                <CardBody className="p-0">
                  ...
                  <Form className="py-4" onSubmit={this.handleFormSubmit}>
                    <FormSectionTitle title="General" description="Setup your general profile details." />
                      ...
                      <Col lg="8">
                        <Row form>
                          ...
                          <Col md="6" className="form-group">
                            ...
                            <FormInput type="text" id="lastName" value="Brooks" onChange={() => {}} />
                          </Col>
                          ...
                          <Col md="6" className="form-group">
                            ...
                            <InputGroup seamless>
                              ...
                              <FormInput id="phoneNumber" value="+40 1234 567 890" onChange={() => {}} />
                            </InputGroup>
                          </Col>
                    ...
                    <FormSectionTitle title="Social" description="Setup your social profiles info." />
                    ...
                    <Row form className="mx-4">
                      <Col tag="label" htmlFor="conversationsEmailsToggle" className="col-form-label">
                        Conversations
                    ...
                    <Row form className="mx-4">
                      ...
                      <Col md="4" className="form-group">
                        ...
                        <FormInput id="oldPassword" placeholder="Old Password" onChange={() => {}} />
                      </Col>

                      {/* Change Password :: New Password */}
                      <Col md="4" className="form-group">
                        <label htmlFor="newPassword">New Password</label>
                        <FormInput id="newPassword" placeholder="New Password" onChange={() => {}} />
                      </Col>

                      {/* Change Password :: Repeat New Password */}
                      <Col md="4" className="form-group">
                        <label htmlFor="repeatNewPassword">Repeat New Password</label>
                        <FormInput id="repeatNewPassword" placeholder="Old Password" onChange={() => {}} />
                      </Col>
                    </Row>
                  </Form>
                </CardBody>
