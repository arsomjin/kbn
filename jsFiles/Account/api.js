        ...
        },
        {
          ...
          Cell: (row) => (
            <ButtonGroup size="sm" className="d-table mx-auto">
              <Button
                theme="white"
                onClick={() => handleItemViewDetails(row.original, 'service')}
                disabled={!grant}
              >
                <i className="material-icons">keyboard_arrow_right</i>
              </Button>
              ...
              <div>
                <Chip
                  ...
                  label={
                    ...
                    IncomeServiceCategories.repairDeposit
                      ? 'มัดจำงานซ่อม'
                      : item.item
                  }
                  clickable
        ...
        },
        {
          ...
          Cell: (row) => (
            <ButtonGroup size="sm" className="d-table mx-auto">
              <Button
                theme="white"
                onClick={() => handleItemViewDetails(row.original, 'parts')}
                disabled={!grant}
              >
                <i className="material-icons">keyboard_arrow_right</i>
              </Button>
        ...
        },
        {
          ...
          Cell: (row) => (
            <ButtonGroup size="sm" className="d-table mx-auto">
              <Button
                theme="white"
                onClick={() => handleItemViewDetails(row.original, 'other')}
                disabled={!grant}
              >
                <i className="material-icons">keyboard_arrow_right</i>
              </Button>
