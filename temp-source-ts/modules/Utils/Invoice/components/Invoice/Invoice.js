...
class Invoice extends Component {
  ...
  handleAddLineItem = event => {
    this.setState({
      ...
      lineItems: this.state.lineItems.concat([{ id: uuidv4(), name: '', description: '', quantity: 0, price: 0.0 }])
    });
  };
      ...
      <div className={styles.invoice}>
        ...
        <div className={styles.footer}>
          <div className={styles.comments}>
            <h4>Notes</h4>
            <p>
              Demo by Kevin Firko, independent consulting developer at <a href='https://bitcurve.com'>Bitcurve</a>.
            </p>
            <p>
              Check out my blog <a href='https://firxworx.com'>https://firxworx.com</a> and{' '}
            ...
            <p>
              Find the <a href='https://github.com/firxworx/react-simple-invoice'>code on Github</a>.
            </p>
          </div>
