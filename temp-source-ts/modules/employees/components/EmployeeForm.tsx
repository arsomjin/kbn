          ...
          <Form form={form} layout='vertical' initialValues={initialValues} onFinish={onFinish}>
            ...
            >
              <Form.Item
                ...
                label={
                  <span>
                    {t('fields.prefix')} <span className='text-red-500'>*</span>
                  </span>
                }
              ...
              <Form.Item
                ...
                label={
                  <span>
                    {t('fields.employeeCode')} <span className='text-red-500'>*</span>
                  </span>
                }
                rules={[{ required: true, message: t('validation.required') }]}
              >
              ...
              <Form.Item
                ...
                label={
                  <span>
                    {t('fields.department')} <span className='text-red-500'>*</span>
                  </span>
                }
                rules={[{ required: true, message: t('validation.required') }]}
              >
              ...
              <Form.Item
                ...
                label={
                  <span>
                    {t('fields.salary')} <span className='text-red-500'>*</span>
                  </span>
                }
                rules={[{ required: true, message: t('validation.required') }]}
              >
              ...
              <Form.Item
                ...
                label={
                  <span>
                    {t('fields.bankAccount')} <span className='text-red-500'>*</span>
                  </span>
                }
                rules={[{ required: true, message: t('validation.required') }]}
              >
            ...
            <Card title={t('fields.emergencyContact.title')} className='mb-6' size={isMobile ? 'small' : 'default'}>
              ...
              >
                <Form.Item
                  ...
                  label={
                    <span>
                      {t('fields.emergencyContactName')} <span className='text-red-500'>*</span>
                    </span>
                  }
                  rules={[{ required: true, message: t('validation.required') }]}
                >
                ...
                <Form.Item
                  ...
                  label={
                    <span>
                      {t('fields.emergencyContactRelationship')} <span className='text-red-500'>*</span>
                    </span>
                  }
                  rules={[{ required: true, message: t('validation.required') }]}
                >
                ...
                <Form.Item
                  ...
                  label={
                    <span>
                      {t('fields.emergencyContactPhone')} <span className='text-red-500'>*</span>
                    </span>
                  }
                  rules={[{ required: true, message: t('validation.required') }]}
                >
