...
const UserRoleManager: React.FC = () => {
  ...
  const { hasPermission, hasProvinceAccess, shouldHideUserFromView } = usePermissions();
    ...
    const fetchUsers = async () => {
      ...
      try {
        ...
        querySnapshot.forEach(doc => {
          ...
          if (shouldHideUserFromView({ email: userData.email || userData.auth?.email || '', role: userData.role })) {
            return;
          }
