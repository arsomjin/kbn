...
const PendingPage: React.FC = () => {
  ...
  const shark = useRef<HTMLHeadingElement>(null);
      ...
      <section className='w-[90vw] max-w-2xl h-full mx-auto flex items-center justify-center relative z-10'>
        ...
        >
          ...
          <p
            ...
            ref={paragraph}
          >
            ยินดีต้อนรับคุณเข้าสู่ครอบครัวของเรา
            <br />
            เราพร้อมให้บริการและสนับสนุนด้านเครื่องจักรกลการเกษตร
            <br />
            เพื่อความก้าวหน้าและความมั่นคงในอาชีพของคุณ
          </p>
          <button
            onClick={explore}
