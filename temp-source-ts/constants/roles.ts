...
export const ROLE_CATEGORIES: Record<RoleCategory, Array<RoleType>> = {
  ...
  [RoleCategory.GENERAL_MANAGER]: [ROLES.GENERAL_MANAGER, ROLES.SUPER_ADMIN, ROLES.DEVELOPER, ROLES.EXECUTIVE],
...
export const ROLE_PERMISSIONS: Record<RoleType, Permission[]> = {
  ...
  [ROLES.EXECUTIVE]: Object.values(PERMISSIONS) as Permission[],
