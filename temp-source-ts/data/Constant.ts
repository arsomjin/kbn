...
export type PriceTypeKey = keyof typeof PriceType;
...
export const FilterSnap = {
  branch: {
    ...
    onFilter: (value: string, record: FilterRecord) => record.branchCode === value
  },
  status: {
    filters: [
      {
    ...
    onFilter: (value: string, record: FilterRecord) => record.status === value
  }
};
